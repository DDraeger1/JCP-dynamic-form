...
function setAssetWithTariftype(
  ...
  function artDarlehen(annuitaetenDarlehen,bausparfinanziert){
    let output=""
    if(annuitaetenDarlehen){
      output="annuitaetenDarlehen"
    } else if(bausparfinanziert){
      output="bausparfinanziert"
    }else{
      output="endfaelligesDarlehen"
    }
  ...
  function mandantMapperbAV(cardTemplateData) {
    let output = 0;

    if (typeof cardTemplateData.versicherungsnehmerId !== "undefined") {
      mandantGroup.forEach((mandant, index) => {
        if (cardTemplateData.versicherungsnehmerId === mandant.mandant.id) {
          output = index;
        }
      });
    } else output = "ARBEITGEBER";
  ...
  function isValueAvailable(key, cardTemplateDataParam) {
    ...
    switch (key) {
      ...
      case "abzuegeVwlGesamt":
        {
          if (cardTemplateDataParam.abzuegeVwl === undefined) {
          } else {
            if (cardTemplateDataParam.abzuegeVwl > 0) {
              output = true;
            }
          }
        }
      ...
      case "sonstigerAbzug":
        {
          if (cardTemplateDataParam.sonstigerAbzug === undefined) {
          } else {
            if (cardTemplateDataParam.sonstigerAbzug > 0) {
              output = true;
            }
          }
        }
      ...
      case "urlaubsgeld":
        {
          if (cardTemplateDataParam.urlaubsgeld === undefined) {
          } else {
            if (cardTemplateDataParam.urlaubsgeld > 0) {
              output = true;
            }
          }
        }
      ...
      case "weihnachtsgeld":
        {
          if (cardTemplateDataParam.weihnachtsgeld === undefined) {
          } else {
            if (cardTemplateDataParam.weihnachtsgeld > 0) {
              output = true;
            }
          }
        }
      ...
      case "gewinnbeteiligung":
        {
          if (cardTemplateDataParam.gewinnbeteiligung === undefined) {
          } else {
            if (cardTemplateDataParam.gewinnbeteiligung > 0) {
              output = true;
            }
          }
        }
...
if (card === "PERSONALDATEN") {
      output = {
        beraterPersonendaten: mandantGroup[mandantTabIndex].mandant.beraterId,
        nebenberaterPersonendaten:
          mandantGroup[mandantTabIndex].mandant.nebenberaterId,
        anredePersonendaten: mandantGroup[mandantTabIndex].mandant.anrede,
        ...
        familienstandPersonendaten:
          mandantGroup[mandantTabIndex].mandant.familienstand,
        ...
        PLZAdressePersonendaten:
          mandantGroup[mandantTabIndex].mandant.postleitzahl,
        hausnummerAdressePersonendaten:
          mandantGroup[mandantTabIndex].mandant.hausnummer,
        cityAdressePersonendaten: mandantGroup[mandantTabIndex].mandant.ort,
        seitWannAdressePersonendaten: dateFormater(
          mandantGroup[mandantTabIndex].mandant.wohnhaftSeit
        ),
        fallschirmspringenHobbysPersonendaten:
          mandantGroup[mandantTabIndex].mandant.fallschirmspringen,
        motorradHobbysPersonendaten:
          mandantGroup[mandantTabIndex].mandant.motorradfahrer,
        karateHobbysPersonendaten: mandantGroup[mandantTabIndex].mandant.karate,
        surfenHobbysPersonendaten: mandantGroup[mandantTabIndex].mandant.surfen,
        jagdHobbysPersonendaten: mandantGroup[mandantTabIndex].mandant.jagd,
        segelnHobbysPersonendaten: mandantGroup[mandantTabIndex].mandant.segeln,
        hobbysMotorbootPersonendaten:
          mandantGroup[mandantTabIndex].mandant.motorboot,
        hobbysTauchenPersonendaten:
          mandantGroup[mandantTabIndex].mandant.tauchen,
        hobbysKletternPersonendaten:
          mandantGroup[mandantTabIndex].mandant.klettern,
        hobbysBergsteigenPersonendaten:
          mandantGroup[mandantTabIndex].mandant.bergsteigen,
        hobbysSonstigesPersonendaten:
          mandantGroup[mandantTabIndex].mandant.sonstiges,
      };
    }
        if (card === "ERWEITERTEBERUFSFRAGEN") {
output = {
        abgeschlosseneAusbildungErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_abgeschlosseneAusbildung,
        personalverantwortungErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_personalverantwortung,
        umfangTaetigkeitErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_umfangDerTaetigkeit,
        anteilkoerperlichErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_anteilKoerperlich,
        anteilBuerotaetigkeitErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_anteilBuero,
        anteilKaufmannErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_anteilKaufmaennisch,
        berufsstandErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_berufsstand,
        dauerSelbststaendigkeitErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_dauerSelbststaendigkeit,
        jaehrlichesEinkommenErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_jaehrlichesEinkommen,
        dienstunfaehigkeitErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_dienstunfaehigkeit,
        aufsichtfuehrendErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_aufsichtsfuehrend,
        dauerLeitendenTaetigkeitErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_dauerLeitend,
        anteilAufsichtfuehrungErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_anteilAufsichtsfuehrend,
        reisetaetigkeitErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_reisetaetigkeit,
        besonderheitenErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_besonderheiten,
        hobbyErwBerufsfragen:mandantGroup[mandantTabIndex].mandant.eb_hobby,
      }
    }
    //e5943e40-9eb4-11ec-a423-001c4270ffe9
    //"14e0b2f8-b72a-11ec-a423-001c4270ffe9"
    if (card === "AUSBILDUNGBERUF") {
      output = {
        beschaeftigungsverhaeltnisAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.beschaeftigungsverhaeltnis,
        imODAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.beschaeftigungOED,
        ausbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.ausbildungFachrichtung,
        erlernterBerufAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.erlernterBeruf,
        berufsbrancheAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.berufsbranche,
        ausgeuebterBerufAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.berufsbezeichnung,
        nebentaetigkeitenAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.berufNotizen,
        ueberwiegendTaetigAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.taetigkeit,
        prozentsatzAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.taetigkeitAnteil,
        leitendTaetigAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.leitendTaetig,
        anzahlMitarbeiterAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.leitendTaetigMA,
        reisetaetigkeitAusbildungBeruf:
          mandantGroup[mandantTabIndex].mandant.reisetaetigkeit,
      };
    }
    if (card === "KIND") {
      output = {
        ...output,
        geschlechtKind: mandantGroup[mandantTabIndex].mandant.anrede,
        vornameKind: mandantGroup[mandantTabIndex].mandant.vorname,
        nameKind: mandantGroup[mandantTabIndex].mandant.nachname,
        geburtsdatumKind: dateFormater(
          mandantGroup[mandantTabIndex].mandant.geburtsdatum
        ),
        geburtsortKind: mandantGroup[mandantTabIndex].mandant.geburtsort,
        gemeinsamesKind: mandantGroup[mandantTabIndex].mandant.gemeinsamesKind,
        versichertBeiKind:
          mandantGroup[mandantTabIndex].mandant.krankenversichertBei,
        steuerIDKind: mandantGroup[mandantTabIndex].mandant.steuerId,
        ausbildungsstandKind:
          mandantGroup[mandantTabIndex].mandant.ausbildungsstand,
        bisKind: mandantGroup[mandantTabIndex].mandant.ausbildungBis,
        fachrichtungKind:
          mandantGroup[mandantTabIndex].mandant.ausbildungFachrichtung,
        berufKind: mandantGroup[mandantTabIndex].mandant.ausbildungBeruf,
        kindergeldBisKind: mandantGroup[mandantTabIndex].mandant.kindergeldBis,
        bezugsberechtigtePersonKindergeldKind:
          mandantGroup[mandantTabIndex].mandant
            .bezugsberechtigePersonKinderfreibetrag,
        bisJahrKinderfreibetragKind:
          mandantGroup[mandantTabIndex].mandant.kinderfreibetragBis,
        kinderfreibetragKind:
          mandantGroup[mandantTabIndex].mandant.kinderfreibetrag,
        bezugsberechtigtePersonKindFreibetragKind:
          mandantGroup[mandantTabIndex].mandant
            .bezugsberechtigePersonKindergeld,
        kinderzulageRiesterKind:
          mandantGroup[mandantTabIndex].mandant.kinderzulageRiester,
      };
    }
    if (card === "BANKVERBINDUNG") {
      output = { ...output, ...anzahlBankverbindungen(bankverbindungenParam) };
    }
    if (card === "ARBEITGEBER") {
      output = {
        ...output,
        ...anzahlArbeitgeber(arbeitgeber.length),
      };
    }
  }
  ...
  function anzahlBankverbindungen(bankDaten) {
    ...
    if (bankDaten.length >= 1) {
      output = {
        bankBankdaten: bankDaten[0].bank,
        kontoInhaberBankdaten:
          mandantGroup[0].mandant.vorname +
          " " +
    ...
    if (bankDaten.length >= 2) {
      output = {
        ...
        kontoInhaberBankdaten2:
          mandantGroup[mandantTabIndex].mandant.vorname +
          " " +
          mandantGroup[mandantTabIndex].mandant.name,
  ...
  function anzahlArbeitgeber(arrayLength) {
    ...
    if (arrayLength >= 1) {
      output = {
        firmennameArbeitgeber: arbeitgeber[0].firmenname,
        rechtsformArbeitgeber: arbeitgeber[0].rechtsform,
        straßeArbeitgeber: arbeitgeber[0].strasse,
        nummerArbeitgeber: arbeitgeber[0].hausnummer,
        postleitzahlArbeitgeber: arbeitgeber[0].postleitzahl,
        wohnortArbeitgeber: arbeitgeber[0].ort,
        telefonnummerArbeitgeber: arbeitgeber[0].tel,
        seitWannbeschaeftigtArbeitgeber: dateFormater(
          arbeitgeber[0].beschaeftigt
        ),
        inGewerkschaftBAVArbeitgeber: arbeitgeber[0].mitgliedGewerkschaft,
        inWelcheGewerkschaftBAVArbeitgeber: arbeitgeber[0].nameGewerkschaft,
        tarifgebundenBAVArbeitgeber: arbeitgeber[0].tarifgebunden,
        ...
        emailAnsprechspartnerArbeitgeber: arbeitgeber[0].avAnsprechpartnerEmail,
        arbeitgeberid0: arbeitgeber[0].id,
      };
    }
    if (arrayLength >= 2) {
      output = {
        ...output,
        selected2Persons: true,
        firmennameArbeitgeber2: arbeitgeber[1].firmenname,
        rechtsformArbeitgeber2: arbeitgeber[1].rechtsform,
        straßeArbeitgeber2: arbeitgeber[1].strasse,
        nummerArbeitgeber2: arbeitgeber[1].hausnummer,
        postleitzahlArbeitgeber2: arbeitgeber[1].postleitzahl,
        wohnortArbeitgeber2: arbeitgeber[1].ort,
        telefonnummerArbeitgeber2: arbeitgeber[1].tel,
        seitWannbeschaeftigtArbeitgeber2: dateFormater(
          arbeitgeber[1].beschaeftigt
        ),
        inGewerkschaftBAVArbeitgeber2: arbeitgeber[1].mitgliedGewerkschaft,
        inWelcheGewerkschaftBAVArbeitgeber2: arbeitgeber[1].nameGewerkschaft,
        tarifgebundenBAVArbeitgeber2: arbeitgeber[1].tarifgebunden,
        ...
        emailAnsprechspartnerArbeitgeber2:
          arbeitgeber[1].avAnsprechpartnerEmail,
        arbeitgeberid1: arbeitgeber[1].id,
      };
    }
    if (arrayLength >= 3) {
      output = {
        ...output,
        selected3Persons: true,
        firmennameArbeitgeber3: arbeitgeber[2].firmenname,
        rechtsformArbeitgeber3: arbeitgeber[2].rechtsform,
        straßeArbeitgeber3: arbeitgeber[2].strasse,
        nummerArbeitgeber3: arbeitgeber[2].hausnummer,
        postleitzahlArbeitgeber3: arbeitgeber[2].postleitzahl,
        wohnortArbeitgeber3: arbeitgeber[2].ort,
        telefonnummerArbeitgeber3: arbeitgeber[2].tel,
        seitWannbeschaeftigtArbeitgeber3: dateFormater(
          arbeitgeber[2].beschaeftigt
        ),
        inGewerkschaftBAVArbeitgeber3: arbeitgeber[2].mitgliedGewerkschaft,
        inWelcheGewerkschaftBAVArbeitgeber3: arbeitgeber[2].nameGewerkschaft,
        tarifgebundenBAVArbeitgeber3: arbeitgeber[2].tarifgebunden,
        ...
        emailAnsprechspartnerArbeitgeber3:
          arbeitgeber[2].avAnsprechpartnerEmail,
        arbeitgeberid2: arbeitgeber[2].id,
      };
    }
    if (arrayLength >= 4) {
      output = {
        ...output,
        selected4Persons: true,
        firmennameArbeitgeber4: arbeitgeber[3].firmenname,
        rechtsformArbeitgeber4: arbeitgeber[3].rechtsform,
        straßeArbeitgeber4: arbeitgeber[3].strasse,
        nummerArbeitgeber4: arbeitgeber[3].hausnummer,
        postleitzahlArbeitgeber4: arbeitgeber[3].postleitzahl,
        wohnortArbeitgeber4: arbeitgeber[3].ort,
        telefonnummerArbeitgeber4: arbeitgeber[3].tel,
        seitWannbeschaeftigtArbeitgeber4: dateFormater(
          arbeitgeber[3].beschaeftigt
        ),
        inGewerkschaftBAVArbeitgeber4: arbeitgeber[3].mitgliedGewerkschaft,
        inWelcheGewerkschaftBAVArbeitgeber4: arbeitgeber[3].nameGewerkschaft,
        tarifgebundenBAVArbeitgeber4: arbeitgeber[3].tarifgebunden,
        ...
        emailAnsprechspartnerArbeitgeber4:
          arbeitgeber[3].avAnsprechpartnerEmail,
        arbeitgeberid3: arbeitgeber[3].id,
      };
    }
    if (arrayLength >= 5) {
      output = {
        ...output,
        selected5Persons: true,
        firmennameArbeitgeber5: arbeitgeber[4].firmenname,
        rechtsformArbeitgeber5: arbeitgeber[4].rechtsform,
        straßeArbeitgeber5: arbeitgeber[4].strasse,
        nummerArbeitgeber5: arbeitgeber[4].hausnummer,
        postleitzahlArbeitgeber5: arbeitgeber[4].postleitzahl,
        wohnortArbeitgeber5: arbeitgeber[4].ort,
        telefonnummerArbeitgeber5: arbeitgeber[4].tel,
        seitWannbeschaeftigtArbeitgeber5: dateFormater(
          arbeitgeber[4].beschaeftigt
        ),
        inGewerkschaftBAVArbeitgeber5: arbeitgeber[4].mitgliedGewerkschaft,
        inWelcheGewerkschaftBAVArbeitgeber5: arbeitgeber[4].nameGewerkschaft,
        tarifgebundenBAVArbeitgeber5: arbeitgeber[4].tarifgebunden,
        ...
        emailAnsprechspartnerArbeitgeber5:
          arbeitgeber[4].avAnsprechpartnerEmail,
        arbeitgeberid4: arbeitgeber[4].id,
      };
    }
    if (arrayLength >= 6) {
      output = {
        ...output,
        selected6Persons: true,
        firmennameArbeitgeber6: arbeitgeber[5].firmenname,
        rechtsformArbeitgeber6: arbeitgeber[5].rechtsform,
        straßeArbeitgeber6: arbeitgeber[5].strasse,
        nummerArbeitgeber6: arbeitgeber[5].hausnummer,
        postleitzahlArbeitgeber6: arbeitgeber[5].postleitzahl,
        wohnortArbeitgeber6: arbeitgeber[5].ort,
        telefonnummerArbeitgeber6: arbeitgeber[5].tel,
        seitWannbeschaeftigtArbeitgeber6: dateFormater(
          arbeitgeber[5].beschaeftigt
        ),
        inGewerkschaftBAVArbeitgeber6: arbeitgeber[5].mitgliedGewerkschaft,
        inWelcheGewerkschaftBAVArbeitgeber6: arbeitgeber[5].nameGewerkschaft,
        tarifgebundenBAVArbeitgeber6: arbeitgeber[5].tarifgebunden,
        ...
        emailAnsprechspartnerArbeitgeber6:
          arbeitgeber[5].avAnsprechpartnerEmail,
        arbeitgeberid5: arbeitgeber[5].id,
      };
    }
    if (arrayLength >= 7) {
  ...
  if (card === "AUSWEIS") {
    output = {
      ...output,
      nummerAusweisdaten: mandantGroup[mandantTabIndex].mandant.personalausweis,
      ausstellungsdatumAusweisdaten:
        dateFormater(
          mandantGroup[mandantTabIndex].mandant.personalausweisAusstellungsdatum
        ) || "",
      gueltigBisAusweisdaten:
        dateFormater(
          mandantGroup[mandantTabIndex].mandant.personalausweisGueltigBis
        ) || "",
      ausstellungsstelleVerwaltungAusweisdaten:
        mandantGroup[mandantTabIndex].mandant.personalausweisVerwaltung,
      reisepassNummerAusweisdaten:
        mandantGroup[mandantTabIndex].mandant.reisepass,
      ausstellungsdatumReisepassAusweisdaten:
        dateFormater(
          mandantGroup[mandantTabIndex].mandant.reisepassAusstellungsdatum
        ) || "",
      gueltigBisReisepassReisepassAusweisdaten:
        dateFormater(
          mandantGroup[mandantTabIndex].mandant.reisepassGueltigBis
        ) || "",
      ausstellungsstelleVerwaltungReisepassAusweisdaten:
        mandantGroup[mandantTabIndex].mandant.reisepassVerwaltung,
      nummerAufenthaltstitelAusweisdaten:
        mandantGroup[mandantTabIndex].mandant.aufenthaltstitelNummer,
      ...
      ortBehoerdeAufenthaltstitelAusweisdaten:
        mandantGroup[mandantTabIndex].mandant.aufenthaltstitelVerwaltung,
      ausstellungsdatumGeburtsurkundeAusweisdaten: dateFormater(
        mandantGroup[mandantTabIndex].mandant.geburtsdatum
      ),
      ausstellungsstelleGeburtsurkundeAusweisdaten:
        mandantGroup[mandantTabIndex].mandant.geburtsurkundeVerwaltung,
      fuehrerscheinFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinNummer,
      ausstellungsDatumFuehrerscheinFuehrerschein: dateFormater(
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinAusstellungsDatum
      ),
      fuehrerscheinLandFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinLand,
      klasseBFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinB,
      klasseBEFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinBE,
      klasseAFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinA,
      klasseAEinsFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinA1,
      klasseAZweiFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinA2,
      klasseCFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinC,
      klasseCEinsFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinC1,
      klasseCEFuehrerschein:
        mandantGroup[mandantTabIndex].mandant.fuehrerscheinCE,
    };
  }
  if (card === "KOMMUNIKATION") {
    output = {
      ...
      versicherungKommunikation:
        mandantGroup[mandantTabIndex].mandant.contactVersicherungen,
      bankgeschaefteKommunikation:
        mandantGroup[mandantTabIndex].mandant.contactBank,
      steuernKommunikation:
        mandantGroup[mandantTabIndex].mandant.contactSteuern,
      rechtlichesKommunikation:
        mandantGroup[mandantTabIndex].mandant.contactRecht,
      privatTelefonFestnetzKommunikation:
        mandantGroup[mandantTabIndex].mandant.telefon,
      geschaeftlichTelefonFestnetzKommunikation:
        mandantGroup[mandantTabIndex].mandant.telefonGeschaeftlich,
      privatMobiltelefonKommunikation:
        mandantGroup[mandantTabIndex].mandant.telefonMobil,
      geschaeftlichMobiltelefonKommunikation:
        mandantGroup[mandantTabIndex].mandant.telefonMobilGeschaeftlich,
  ...
  if (card === "GESUNDHEIT") {
    ...
    output = {
      ...output,
      groesseGesundheit: mandantGroup[mandantTabIndex].mandant.grosse,
      gewichtGesundheit: mandantGroup[mandantTabIndex].mandant.gewicht,
      motorradfahrerGesundheit:
        mandantGroup[mandantTabIndex].mandant.motorradfahrer,
      antwortRauchenGesundheit: mandantGroup[mandantTabIndex].mandant.raucher,
      seitRauchenGesundheit: dateFormater(
        mandantGroup[mandantTabIndex].mandant.raucherSeit
      ),
      brilleSehvermoegenGesundheit:
        mandantGroup[mandantTabIndex].mandant.sehhilfeBrille,
      kontaktlinsenSehvermoegenGesundheit:
        mandantGroup[mandantTabIndex].mandant.sehhilfeKontaklinsen,
      erlaeuterungenSehvermoegenGesundheit:
        mandantGroup[mandantTabIndex].mandant.sehhilfeAngaben,
      linksDioptrienSehvermoegenGesundheit:
        mandantGroup[mandantTabIndex].mandant.sehhilfeLinks,
      rechtsDioptrienSehvermoegenGesundheit:
        mandantGroup[mandantTabIndex].mandant.sehhilfeRechts,
      antwortUnfallbestandGesundheit:
        mandantGroup[mandantTabIndex].mandant.verletzt10,
      zeitraumVonUnfallbestandGesundheit: dateFormater(
        mandantGroup[mandantTabIndex].mandant.verletzt10Zeitraum
      ),
      inBehandlungUnfallbestandGesundheit:
        mandantGroup[mandantTabIndex].mandant.verletzt10Behandlung,
      beschwerdefreiGeheiltUnfallbestandGesundheit:
        mandantGroup[mandantTabIndex].mandant.verletzt10Geheilt,
      behandlungGesundheit: mandantGroup[mandantTabIndex].mandant.krankenhaus10,
      zeitraumBehandlungGesundheit:
        mandantGroup[mandantTabIndex].mandant.krankenhaus10Zeitraum,
      beschwerdefreiGeheiltBehandlungGesundheit:
        mandantGroup[mandantTabIndex].mandant.krankenhaus10Geheilt,

      zeitraumUnfallbestandGesundheit:
        mandantGroup[mandantTabIndex].mandant.verletzt10Zeitraum,

      antwortOperationenGesundheit:
        mandantGroup[mandantTabIndex].mandant.operation10,
      zeitraumOperationenGesundheit:
        mandantGroup[mandantTabIndex].mandant.operation10Zeitraum,
      diagnoseOperationenGesundheit:
        mandantGroup[mandantTabIndex].mandant.operation10Diagnose,
      beschwerdefreiGeheiltOperationenGesundheit:
        mandantGroup[mandantTabIndex].mandant.operation10Geheilt,
      seitOperationenGesundheit:
        mandantGroup[mandantTabIndex].mandant.operation10GeheiltSeit,
      KHTageOperationenGesundheit:
        mandantGroup[mandantTabIndex].mandant.operation10GeheiltKHTage,
      AUTageOperationenGesundheit:
        mandantGroup[mandantTabIndex].mandant.operation10GeheiltAUTage,
      antwortGesundheitUndArbeitsfaehigkeitGesundheit:
        mandantGroup[mandantTabIndex].mandant.arbeitsfaehig,
      notizenGesundheitUndArbeitsfaehigkeitGesundheit:
        mandantGroup[mandantTabIndex].mandant.arbeitsfaehigUrsache,
      antwortDerzeitigeZahnbehandlungenGesundheit:
        mandantGroup[mandantTabIndex].mandant.zahnpflege,
      angabenDerzeitigeZahnbehandlungenGesundheit:
        mandantGroup[mandantTabIndex].mandant.zahnpflegeAngaben,
      antwortFehlendeZaehneGesundheit:
        mandantGroup[mandantTabIndex].mandant.fehlenZaehne,
      anzahlFehlendeZaehneGesundheit:
        mandantGroup[mandantTabIndex].mandant.fehlenZaehneAnzahl,
      zahnersatzGesundheit: mandantGroup[mandantTabIndex].mandant.zahnersatz,
      anzahlZahnersatzGesundheit:
        mandantGroup[mandantTabIndex].mandant.zahnersatzErsetzterZaehne,
      bestehtSeitZahnersatzGesundheit:
        mandantGroup[mandantTabIndex].mandant.zahnersatzJahren,
    };
  }
  if (card === "STEUERN") {
    cardTemplateData = {
      ...output,
      initMandantValue: mandantMapper(mandantGroup[mandantTabIndex].mandantId),
      versicherungsnehmerGesetzlicheAltersvorsorge: mandantMapper(
        mandantGroup[mandantTabIndex].mandantId
      ),
      steuerklasseSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.steuerklasse,
      kinderfreibetragSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.kinderfreibetrag,
      fuerSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.sonstFreibetraegeFuer,
      steuerlVeranlagungSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern
          .steuerlicheVeranlagungGemeinsam,
      kirchensteuerSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.kirchensteuer,
      zustFinanzamtSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.zustaendigesFinanzamt,
      steuernummerSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.steuernummer,
      steuerIDSteuern: mandantGroup[mandantTabIndex].mandant.steuern.steuerId,
      sozialversNummerSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.sozialversicherungsnummer,
      zustFamilienkasseSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.zustaendigeFamilienkasse,
      kindergeldnummerSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.kindergeldnummer,
      steuerberatungDurchSteuern:
        mandantGroup[mandantTabIndex].mandant.steuern.steuerberatungDurch,
    };
  }
  if (!changedMandant) {
    asset.map((asset) => {
    ...
    switch (card) {
      case "GAS":
        ...
        output={
          ...
          tarifbezeichnungGas:cardTemplateData.tarifbezeichnung,
          personenzuordnungGas:mandantMapper(
            cardTemplateData.versicherungsnehmer.id
          ),
          anbieterGas:cardTemplateData.gesellschaft,
          versicherungsnummerGas:cardTemplateData.versicherungsnummer,
          jaehrlicherVerbrauchGas:cardTemplateData.jaehrlicherVerbrauch,
          vertragslaufzeitGas:dateFormater(cardTemplateData.versicherungsbeginn),
          vertragslaufzeitGas:dateFormater(cardTemplateData.versicherungsende),
          zahlweiseGas:cardTemplateData.zahlweise,
          beitragGas:cardTemplateData.beitrag
        }
        break
      case "STROM":
        console.log(cardTemplateData)
        output={
          ...
          tarifbezeichnungStrom:cardTemplateData.tarifbezeichnung,
          personenzuordnungStrom:mandantMapper(
            cardTemplateData.versicherungsnehmer.id
          ),
          anbieterStrom:cardTemplateData.gesellschaft,
          versicherungsnummerStrom:cardTemplateData.versicherungsnummer,
          jaehrlicherVerbrauchStrom:cardTemplateData.jaehrlicherVerbrauch,
          vertragslaufzeitStrom:dateFormater(cardTemplateData.versicherungsbeginn),
          vertragslaufzeitStrom:dateFormater(cardTemplateData.versicherungsende),
          zahlweiseStrom:cardTemplateData.zahlweise,
          beitragStrom:cardTemplateData.beitrag
        }
        break
      case "BEAMTENBEIHILFE":
        output={
          versicherungsnehmerBeamtenbeihilfe:mandantMapper(
            cardTemplateData.versicherungsnehmer.id
          ),
          artBeihilfeBeamtenbeihilfe:cardTemplateData.art,
          ambulantHoeheBeamtenbeihilfe:cardTemplateData.ambulant,
          stationaerHoeheBeamtenbeihilfe:cardTemplateData.stationaer,
          anspruchBeamtenbeihilfe:cardTemplateData.anspruchFreieHeilfuersorge,
          anwartschaftversicherungBeamtenbeihilfe:cardTemplateData.anwartschaftsversicherung,
          bundeslandBeamtenbeihilfe:cardTemplateData.bundesland,
        }
        break;
      case "BERUFSSTAENDISCHE_VORSORGE":
        output={
          versicherungsnehmerBerufsstandischeVersorgung:mandantMapper(
            cardTemplateData.versicherungsnehmer.id
          ),
          gesellschaftBerufsstandischeVersorgung:cardTemplateData.gesellschaft,
          renteneintrittBerufsstandischeVersorgung:dateFormater(cardTemplateData.renteneintritts),
          renteBUEMBerufsstandischeVersorgung:cardTemplateData.buRente,
          kapitalleistungBerufsstandischeVersorgung:cardTemplateData.kapitalleistung,
          rentenanwartschaftBerufsstandischeVersorgung:cardTemplateData.monatRentenanwartschaft,
          monatlicheAltersrenteBerufsstandischeVersorgung:cardTemplateData.monatAltersrente,
          witwenrenteBerufsstandischeVersorgung:cardTemplateData.witwenrente,
          waisenrenteBerufsstandischeVersorgung:cardTemplateData.waisenrente,
          zahlweiseBerufsstandischeVersorgung:cardTemplateData.zahlweise,
          beitragBerufsstandischeVersorgung:cardTemplateData.beitrag,
        }
        break;
      case "BEAMTENVERSORGUNG":
        output={
          berufsstandischeVersorgung:mandantMapper(
            cardTemplateData.versicherungsnehmer.id
          ),
          bundBeamtenversorgung:cardTemplateData.bundesbeamter,
          bundeslandBeamtenversorgung:cardTemplateData.bundesland,
          besoldungsgruppeBeamtenversorgung:cardTemplateData.besoldungsgruppe,
          stufeBeamtenversorgung:cardTemplateData.stufe,
          dienstjahreBeamtenversorgung:cardTemplateData.ruhegehaltsfaehigeDienstjahre,
          zulagenBeamtenversorgung:cardTemplateData.ruhegehaltsfaehigeZulagen,
          beamtenstatusBeamtenversorgung:cardTemplateData.beamtenstatus,
          wartezeitBeamtenversorgung:cardTemplateData.wartezeitErfuellt,
          vollzeitBeamtenversorgung:booleanFormater(cardTemplateData.vollzeit),
          teilzeitBeamtenversorgung:cardTemplateData.teilzeitStunden,
          vonZividienstzeitenBeamtenversorgung:dateFormater( cardTemplateData.wehrZivilVon),
          bisZividienstzeitenBeamtenversorgung:dateFormater(cardTemplateData.wehrZivilBis),
          vonHochschulzeitenBeamtenversorgung:dateFormater(cardTemplateData.fachHochschulVon),
          bisHochschulzeitenBeamtenversorgung:dateFormater(cardTemplateData.fachHochschulBis),
          rentenbeginnBeamtenversorgung:dateFormater(cardTemplateData.versicherungsbeginn), // maybe not?
          pensionsanspruchBeamtenversorgung:cardTemplateData.pensionsanspruch,
          dienstunfähigkeitsrenteBeamtenversorgung:cardTemplateData.dienstunfaehigkeitsrente,
          witwerrenteBeamtenversorgung:cardTemplateData.witwenrente,
        }
        break;
      case "BAUHERRENHAFTPFLICHT":
        output={
          versicherungsnehmerBauherrenhaftpflicht:mandantMapper(
            cardTemplateData.versicherungsnehmer.id
          ),
          gesellschaftBauherrenhaftpflicht:cardTemplateData.gesellschaft,
          vertragsnummerBauherrenhaftpflicht:cardTemplateData.versicherungsnummer,
          bausummeBauherrenhaftpflicht:cardTemplateData.versicherungssumme,
          wohnflaecheBauherrenhaftpflicht:cardTemplateData.wohnflaeche,
          hoeheEigenleistungenBauherrenhaftpflicht:cardTemplateData.bausumme,
          selbstbeteiligungBauherrenhaftpflicht:cardTemplateData.sb,
          fertighausBauherrenhaftpflicht:cardTemplateData.fertighaus,
          vertragsbeginnBauherrenhaftpflicht:dateFormater(cardTemplateData.versicherungsbeginn),
          vertragsendeBauherrenhaftpflicht:dateFormater(cardTemplateData.versicherungsende),
          anzahlVorschaedenFuenfJahreBauherrenhaftpflicht:cardTemplateData.vorschaedenAnzahl,
          anzahlVorschaedenBauherrenhaftpflicht:cardTemplateData.vorschaedenHoehe,
          vorschadensummeBauherrenhaftpflicht:cardTemplateData.vorschaedenNotiz,
        }
        break;
      case "WASSERSPORTHAFTPFLICHT":
        output={
          versicherungsnehmerWassersporthaftpflicht:mandantMapper(
            cardTemplateData.versicherungsnehmer.id
          ),
          gesellschaftWassersporthaftpflicht:cardTemplateData.gesellschaft,
          vertragsnummerWassersporthaftpflicht:cardTemplateData.versicherungsnummer,
          versicherungssummeWassersporthaftpflicht:cardTemplateData.versicherungssumme,
          selbstbeteiligungWassersporthaftpflicht:cardTemplateData.sb,
          motorbootWassersporthaftpflicht:cardTemplateData.kwMotorboot,
          segelflaecheWassersporthaftpflicht:cardTemplateData.segelflaeche,
          vertragsbeginnWassersporthaftpflicht:dateFormater(cardTemplateData.versicherungsbeginn),
          vertragsendeWassersporthaftpflicht:dateFormater(cardTemplateData.versicherungsende),
          anzahlVorschaedenFuenfJahreWassersporthaftpflicht:cardTemplateData.vorschaedenAnzahl,
          anzahlVorschaedenWassersporthaftpflicht:cardTemplateData.vorschaedenHoehe,
          vorschadensummeWassersporthaftpflicht:cardTemplateData.versicherungssumme,
        }
        break;
      case "GEWAESSERSCHADENHAFTPFLICHT":
        ...
        output={
          ...
          gesellschaftGewaesserschadenhaftpflicht:cardTemplateData.gesellschaft,
          tarifgruppeGewaesserschadenhaftpflicht:cardTemplateData.tarifgruppe,
          versicherungssummeGewaesserschadenhaftpflicht:cardTemplateData.versicherungssumme,
          vertragsnummerGewaesserschadenhaftpflicht:cardTemplateData.versicherungsnummer,
          selbstbeteiligungGewaesserschadenhaftpflicht:cardTemplateData.sb,
          fassungsvermoegenGewaesserschadenhaftpflicht:cardTemplateData.fassung,
          tankortGewaesserschadenhaftpflicht:cardTemplateData.tankort,
          immobilienartGewaesserschadenhaftpflicht:cardTemplateData.immobilienart,
          vertragsbeginnGewaesserschadenhaftpflicht:dateFormater(cardTemplateData.versicherungsbeginn),
          vertragsendeGewaesserschadenhaftpflicht:dateFormater(cardTemplateData.versicherungsende),
          zahlweiseGewaesserschadenhaftpflicht:cardTemplateData.zahlweise,
          beitragGewaesserschadenhaftpflicht:cardTemplateData.beitrag,
          anzahlVorschaedenFuenfJahreGewaesserschadenhaftpflicht:cardTemplateData.vorschaedenAnzahl,
          anzahlVorschaedenGewaesserschadenhaftpflicht:cardTemplateData.vorschaedenHoehe,
          vorschadensummeGewaesserschadenhaftpflicht:cardTemplateData.versicherungssumme,
        }
        break;
        case "JAGDHAFTPFLICHT":
          console.log(cardTemplateData)
output={
  tarifbezeichnungJagdhaftpflicht:cardTemplateData.tarifBezeichnung,
  versicherungsnehmerJagdhaftpflicht:mandantMapper(
    cardTemplateData.versicherungsnehmer.id
  ),
  gesellschaftJagdhaftpflicht:cardTemplateData.gesellschaft,
  versicherungsnummerJagdhaftpflicht:cardTemplateData.versicherungsnummer,
  versicherungssummeJagdhaftpflicht:cardTemplateData.versicherungssumme,
  selbstbeteiligungJagdhaftpflicht:cardTemplateData.sb,
  vertragsbeginnJagdhaftpflicht:dateFormater(cardTemplateData.versicherungsbeginn),
  vertragsendeJagdhaftpflicht:dateFormater(cardTemplateData.versicherungsende),
  zahlweiseJagdhaftpflicht:cardTemplateData.zahlweise,
  beitragJagdhaftpflicht:cardTemplateData.beitrag,
  anzahlVorschaedenFuenfJahreJagdhaftpflicht:cardTemplateData.vorschaedenAnzahl,
  anzahlVorschaedenJagdhaftpflicht:cardTemplateData.vorschaedenHoehe,
  vorschadensummeJagdhaftpflicht:cardTemplateData.vorschaedenNotiz,
}
        break
        case "RENTE":
          console.log(cardTemplateData)
          output={
            versicherungsnehmerRente:mandantMapper(
              cardTemplateData.versicherungsnehmer.id
            ),
            gesellschaftRente:cardTemplateData.gesellschaft,
            nettoRente:cardTemplateData.renteNetto,
            bruttoRente:cardTemplateData.renteBrutto,
            artRente:cardTemplateData.rentenArt,
            vertragsbeginnRente:dateFormater(cardTemplateData.versicherungsbeginn) ,
            vertragsendeRente:dateFormater(cardTemplateData.versicherungsende),
            zahlungVonRente:dateFormater(cardTemplateData.zahlungVon),
            zahlungBisRente:dateFormater(cardTemplateData.zahlungBis),
            zahlweiseRente:cardTemplateData.zahlweise,
          }
          break;
      case "DARLEHEN":
        console.log(cardTemplateData)
        output = {
          initMandantValue: checkForBeide(
            cardTemplateData
          ),
          externalProduktId: cardTemplateData.externalProduktId,
          restschuldBerechnen:cardTemplateData.berechneteRestschuld,
          tarifbezeichnungDarlehen: cardTemplateData.tarifBezeichnung,
          vertragsnummerDarlehen: cardTemplateData.versicherungsnummer,
          darlehensnehmerDarlehen: checkForBeide(cardTemplateData),
          artDarlehen:artDarlehen(cardTemplateData.annuitaetenDarlehen,cardTemplateData.bausparfinanziert),
          zugeordneteImmobilieObjektzuordnungDarlehen:
            cardTemplateData.objektnotizen, 
          darlehenshoeheBeginnObjektzuordnungDarlehen:
            cardTemplateData.darlehenshohe,
          restschuldObjektzuordnungDarlehen: cardTemplateData.restschuld,
          standVomObjektzuordnungDarlehen: dateFormater(
            cardTemplateData.standVom
          ),
          ...
          zinsfestschreibungObjektzuordnungDarlehen: dateFormater(
            cardTemplateData.zinsfestschreibung
          ),
          tilgungProzentObjektzuordnungDarlehen:
            cardTemplateData.tilgungProzent,
          tilgungEuroObjektzuordnungDarlehen: 0,
          sondertilgungProzentObjektzuordnungDarlehen:
            cardTemplateData.sondertilgungProzent,
          beginnObjektzuordnungDarlehen: dateFormater(
            cardTemplateData.versicherungsbeginn
          ),
          voraussichtlichSchuldenfreiObjektzuordnungDarlehen: "Placeholder",
        };
        break;
      case "RUERUP":
        console.log(cardTemplateData);
        output = {
          ...
          vertragsbeginnVertragslaufzeitRuerupRente: dateFormater(
            cardTemplateData.versicherungsbeginn
          ),
          vertragsendeVertragslaufzeitRuerupRente: dateFormater(
          ...
          beitragsendeBUZRuerupRente: dateFormater(
            cardTemplateData.beitragsendeBUZ
          ),
          leistungsendeBUZRuerupRente: dateFormater(
          ...
          zusatzversicherungHinterbliebenenZusatzversicherungRuerupRente:
            cardTemplateData.hinterbliebenenZusatz,
          prozentHinterbliebenenZusatzversicherungRuerupRente:
            cardTemplateData.hinterbliebenenProzent,
          betragHinterbliebenenZusatzversicherungRuerupRente:
            cardTemplateData.hinterbliebenenBetrag,
      ...
      case "RIESTER":
        ...
        output = {
          ...
          aktuellerRueckkaufswertBUZRiesterrente:
            cardTemplateData.rueckkaufswert,
          datumBUZRiesterrente: dateFormater(
            cardTemplateData.rueckkaufswertDatum
          ),
          beitragsendeFondsRiesterrente: "Placeholder",
          VWLRiesterrente: false,
          arbeitgeberanteilVWLRiesterrente: "Placeholder",
          arbeitnehmeranteilVWLRiesterrente: "Placeholder",
          summeVWLRiesterrente: "Placeholder",
      ...
      case "SACHWERT":
        ...
        output = {
          ...
          fallsSonstigesVertragspartnerSachwert:"Placeholder",
      ...
      case "DIREKTZUSAGE":
        output = {
          externalProduktId: cardTemplateData.externalProduktId,
          initMandantValue: mandantMapperbAV(
            cardTemplateData
          ),
          gesellschaftBetrieblicheAltersversorgung:
            cardTemplateData.gesellschaft,
          tarifbezeichnungBetrieblicheAltersversorgung:
            cardTemplateData.tarifBezeichnung,
          vertragsnummerBetrieblicheAltersversorgung:
            cardTemplateData.versicherungsnummer,
          versicherungsnehmerBetrieblicheAltersversorgung: mandantMapperbAV(
            cardTemplateData
          ),
          ...
          vertragsendeVertragslaufzeitBetrieblicheAltersversorgung:
            dateFormater(cardTemplateData.versicherungsende),
          ...
          renteBUBetrieblicheAltersversorgung:
            cardTemplateData.rentenleistungBU,
      ...
      case "GESETZLICHE_AV":
        ...
        output = {
          ...
          wartezeitGesetzlicheAltersvorsorge:
            cardTemplateData.wartezeitErfuellt,
      ...
      case "EINNAHMEN":
        ...
        let einnahmeartArray = [
          {
            name: "nichtselbststaendigeTaetigkeitEinnahmen",
            value: cardTemplateData.nichtselbststaendigeTaetigkeit,
          },
          {
            name: "kapitalvermoegenEinnahmen",
            value: cardTemplateData.kapitalvermogen,
          },
          {
            name: "vermietungUndVerpachtungEinnahmen",
            value: cardTemplateData.vermietungUndVerpachtung,
          },
          {
            name: "landUndForstwirtschaftEinnahmen",
            value: cardTemplateData.landUndForstwirtschaft,
          },
          {
            name: "gewerbebetriebEinnahmen",
            value: cardTemplateData.gewerbebetrieb,
          },
          {
            name: "sonstigeEinkünfteEinnahmen",
            value: cardTemplateData.sonstigeEinkuenfte22Renten,
          },
          {
            name: "außerordentlicheEinkuenfteEinnahmen",
            value: cardTemplateData.ausserordentlicheEinkuenfte,
          },
          {
            name: "steuerfreieEinnahmenUnterProgessionsvorbehaltEinnahmen",
            value:
              cardTemplateData.steuerfreieEinnahmenUnterProgressionsvorbehalt,
          },
          {
            name: "selbststaendigeTaetigkeitEinnahmen",
            value: cardTemplateData.selbststaendigeTaetigkeit,
          },
        ];
...
artKapitalversicherung: cardTemplateData.art,
  versicherungsnehmerKapitalversicherung: mandantMapper( cardTemplateData.versicherungsnehmer.id),
  produktIDGesellschaftKapitalversicherung: cardTemplateData.externalProduktId,
  tarifbezeichnungGesellschaftKapitalversicherung: cardTemplateData.tarifBezeichnung,
  vertragsnummerGesellschaftKapitalversicherung: cardTemplateData.versicherungsnummer,
  verwendungszweckKapitalversicherung: cardTemplateData.verwendungszweckArt,
  fallsSonstigesVerwendungszweckKapitalversicherung: cardTemplateData.verwendungszweck,
  versichertePersonKapitalversicherung: cardTemplateData.versichertePersonId,
  vertragsbeginnVertragslaufzeitKapitalversicherung:dateFormater( cardTemplateData.versicherungsbeginn),
  vertragsendeVertragslaufzeitKapitalversicherung: dateFormater( cardTemplateData.versicherungsende),
  versicherungssummeVertragslaufzeitKapitalversicherung: cardTemplateData.versicherungssumme,
  dynamikKapitalversicherung: cardTemplateData.dynamik,
  prozentDynamikKapitalversicherung: cardTemplateData.dynamikProzent,
  fondsDynamikKapitalversicherung: cardTemplateData.fonds,
  beitragszahlerDynamikKapitalversicherung: cardTemplateData.beitragszahler,
  bezugsrechtTodesfallDynamikKapitalversicherung: cardTemplateData.bezugsrechtTod,
  leistungTodDynamikKapitalversicherung: cardTemplateData.leistungTod,
  garantiertMonatlicheRentenleistungKapitalversicherung: cardTemplateData.rentenleistungGarantiert,
  prognostiziertMonatlicheRentenleistungKapitalversicherung: cardTemplateData.rentenleistungPrognostiziert,
  beiMonatlicheRentenleistungKapitalversicherung: cardTemplateData.rentenleistungPrognostiziertBeiProzent,
  RGZMonatlicheRentenleistungKapitalversicherung: cardTemplateData.rentenleistungRgzJahre,
  garantiertAblaufleistungKapitalversicherung: cardTemplateData.ablaufleistungGarantiert,
  prognostiziertAblaufleistungKapitalversicherung: cardTemplateData.ablaufleistungPrognostiziert,
  beiAblaufleistungKapitalversicherung: cardTemplateData.ablaufleistungPrognostiziertBeiProzent,
  inetgrierteBUKapitalversicherung: cardTemplateData.integrierteBU,
  rentenleistungBUKapitalversicherung: cardTemplateData.rentenleistungBU,
  beitragsbefreiungBUKapitalversicherung: cardTemplateData.beitragsbefreiungBU,
  beitragsendeBUZKapitalversicherung: dateFormater( cardTemplateData.beitragsendeBUZ),
  leistungsendeBUZKapitalversicherung:dateFormater(cardTemplateData.leistungsendeBUZ),
  beitragsanteilBUZKapitalversicherung: cardTemplateData.beitragsanteilBUZ,
  vertagAbgetretenBUZKapitalversicherung: cardTemplateData.vertragAbgetreten,
  aktuellerRueckkaufswertBUZKapitalversicherung: cardTemplateData.rueckkaufswert,
  datumBUZKapitalversicherung: dateFormater(cardTemplateData.rueckkaufswertDatum),
  garantiezinsBUZKapitalversicherung: "Placeholder",
  veitragsendeBUZKapitalversicherung: dateFormater(cardTemplateData.beitragsende),
  VWLKapitalversicherung: "Placeholder",
  arbeitgeberanteilVWLKapitalversicherung: cardTemplateData.rentenleistungGarantiert,
  arbeitnehmeranteilVWLKapitalversicherung:cardTemplateData.rentenleistungPrognostiziert,
  summeVWLKapitalversicherung: "Placeholder",
  zahlweiseVWLKapitalversicherung: cardTemplateData.zahlweise,
  einmalbeitragVWLKapitalversicherung: cardTemplateData.einmalbeitrag,
  gesamtzahlbeitragVWLKapitalversicherung: cardTemplateData.beitrag,
  beitragsanteilVWLKapitalversicherung: cardTemplateData.beitragsanteilFuerBU,
}
        break;
      case "EINKOMMEN_GEHALT":
        console.log(cardTemplateData);
        output = {
          ...
          jobRadGesamtBruttoSelectEinnahmen:
            cardTemplateData.jobradGesamtbrutto,
          ...
          sonstigesBrutto: isValueAvailable(
            "sonstigesBrutto",
            cardTemplateData
          ),
      ...
      case "KONSUMKREDIT":
        ...
        output = {
          ...
          beginnKonsumkredit: dateFormater(
            cardTemplateData.versicherungsbeginn
          ),
      ...
      case "PFERDEHALTERHAFTPFLICHT":
        ...
        output = {
          ...
          hoeheVorschaedenPferdehalterpflicht:
            cardTemplateData.vorschaedenHoehe,
          listeVorschaedenPferdehalterpflicht:
            cardTemplateData.vorschaedenNotiz,
        };
        break;
      case "BANKPRODUKTE":
        output = {
      ...
      case "VWL_BAUSPAREN":
        output = {
          ...
          summeVwlVwlUndBausparen:
            ...
            guthabenVwlUndBausparen:cardTemplateData.guthaben
        };
      ...
      case "IMMOBILIENBESTAND":
        ...
        output = {
          ...
          belastungUeberschussImmobilienbestand:
            cardTemplateData.hasUeberschuss,
      ...
      case "BETEILIGUNGEN":
        ...
        output = {
          ...
          investitionsthemaVertragsinhaberBeteiligungenAiF:
            cardTemplateData.anlageform,
          zeichnungssummeVertragsinhaberBeteiligungenAiF:
            cardTemplateData.beteiligungssumme,
          beginnVertragsinhaberBeteiligungenAiF: dateFormater(
            cardTemplateData.versicherungsbeginn
          ),
          endeVertragsinhaberBeteiligungenAiF: dateFormater(
            cardTemplateData.versicherungsende
          ),
          einmalbeitragVertragsinhaberBeteiligungenAiF:
            cardTemplateData.einmalbeitrag,
          beitragVertragsinhaberBeteiligungenAiF: cardTemplateData.beitrag,
          jaehrlAusschuettungVertragsinhaberBeteiligungenAiF:
            cardTemplateData.prognose,
          aktuellerWertVertragsinhaberBeteiligungenAiF: cardTemplateData.wert,
      ...
      case "BU":
        ...
        output = {
          ...
          fallsDynamikVertragslaufzeitBuEuGjk:cardTemplateData.dynamikProzent,
      ...
      case "UNFALL":
        ...
        output = {
          ...
          unfallKrankentagegeldLeistungenUnfall:
            cardTemplateData.krankentagegeld,
          ...
          wieVielterTagLeistungenUnfall3: cardTemplateData.krankentagegeldtag3,
          ...
          wieVielterTagLeistungenUnfall4: cardTemplateData.krankentagegeldtag4,
          ...
          wieVielterTagLeistungenUnfall5: cardTemplateData.krankentagegeldtag5,
          ...
          unfallKrankentagegeldLeistungenUnfall:
            cardTemplateData.krankentagegeld,
          wieVielterTagLeistungenUnfall6: cardTemplateData.krankentagegeldtag6,
      ...
      console.log(cardTemplateData);
        output = {
          ...
          versichertePersonTodesfall:
            ...
            sonstigePersonTodesfall:cardTemplateData.versichertePersonSonstige,
          ...
          vertragAbgetretenVersicherungssummeTodesfall:
            ...
            integrierteBURentenleistunggVersicherungssummeTodesfall:cardTemplateData.integrierteBuRenten,
            gesamtzahlbeitragTodesfall:cardTemplateData.beitrag,
      ...
      case "DREADDISEASE":
        output = {
          ...
          vertragsnummerSchwereKrankheiten:cardTemplateData.versicherungsnummer,
      ...
      case "KVZ":
        ...
        output = {
          ...
          regelversorgungLeistungenZahnKVZusatz:
            cardTemplateData.regelversorgung,
          ...
          stationaerVersichertePersonKVZusatz2:
            cardTemplateData.inklStationaer2,
          ...
          GKVTarifLeistungenStationaerKVZusatz2:
            cardTemplateData.gkvZuzahlungen2,
          ...
          altersrueckstellungKTKVZusatz2:
            cardTemplateData.altersrueckstellungKT2,
          ...
          stationaerVersichertePersonKVZusatz3:
            cardTemplateData.inklStationaer3,
          ...
          GKVTarifLeistungenStationaerKVZusatz3:
            cardTemplateData.gkvZuzahlungen3,
          ...
          altersrueckstellungKTKVZusatz3:
            cardTemplateData.altersrueckstellungKT3,
          ...
          stationaerVersichertePersonKVZusatz4:
            cardTemplateData.inklStationaer4,
          ...
          GKVTarifLeistungenStationaerKVZusatz4:
            cardTemplateData.gkvZuzahlungen4,
          ...
          altersrueckstellungKTKVZusatz4:
            cardTemplateData.altersrueckstellungKT4,
          ...
          stationaerVersichertePersonKVZusatz5:
            cardTemplateData.inklStationaer5,
          ...
          GKVTarifLeistungenStationaerKVZusatz5:
            cardTemplateData.gkvZuzahlungen5,
          ...
          altersrueckstellungKTKVZusatz5:
            cardTemplateData.altersrueckstellungKT5,
          ...
          stationaerVersichertePersonKVZusatz6:
            cardTemplateData.inklStationaer6,
          ...
          GKVTarifLeistungenStationaerKVZusatz6:
            cardTemplateData.gkvZuzahlungen6,
          ...
          altersrueckstellungKTKVZusatz6:
            cardTemplateData.altersrueckstellungKT6,
      ...
      case "HAUSRAT":
        ...
        output = {
          ...
          tarifOeffentlicherDienstVersicherungssummeHausrat:
            cardTemplateData.oeffentlicherDienst,
            vertragsbeginnVertragslaufzeitHausrat:dateFormater(cardTemplateData.versicherungsbeginn),
            vertragsendeVertragslaufzeitHausrat:dateFormater(cardTemplateData.versicherungsende),
            zahlweiseHausrat:cardTemplateData.zahlweise,
            beitragHausrat:cardTemplateData.beitrag,
      ...
      case "RECHTSSCHUTZ":
        ...
        output = {
          ...
          verkehrRechtschutzpaketDeckumfangRechtschutz:
            cardTemplateData.verkehr,
      ...
      case "WOHNGEBAEUDE":
        output = {
          ...
          leitungswasserAbsicherungWohngebaeude:
            cardTemplateData.leitungswasser,
          ...
          fallsSonstigesWaendeWohngebaeude:
            cardTemplateData.waendeSonstigesText,
      ...
      case "KFZ":
        ...
        output = {
          ...
          beitragGeschaeftsausgabeBeitragKFZ:
            cardTemplateData.geschaeftsausgabe,
      ...
      case "WOHNSITUATION":
        ...
        output = {
          ...
          kaltmieteMieteProMonatWohnsituation:
            cardTemplateData.wohnungKaltmiete,
    ...
    if (!checkIfPersonendaten(card)) {
      output = {
        ...output,
        externalProduktId: cardTemplateData.externalProduktId,
        notizen:cardTemplateData.notizen
      };
    }
    if(typeof(cardTemplateData.name) !== "undefined"){
